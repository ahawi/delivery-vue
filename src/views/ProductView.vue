  ...
  <section class="container">
    <div class="catalog">
      <div class="catalog__header">
        <h1 class="catalog__header-title h2">Тануки</h1>
        <div class="catalog__header-description">
          <span class="catalog__header-description-rating"> 4.5 </span>
          <span class="catalog__header-description-price">От 900 ₽</span>
          <span class="catalog__header-description-category">Пицца и суши</span>
        </div>
      </div>
      <ul class="catalog__list grid grid--catalog">
        <li class="catalog__item" v-for="goods in goodsArray" :key="goods.id">
          <img
          ...
          <div class="catalog__item-about">
            <h2 class="catalog__item-title h3">{{ goods.title }}</h2>
            <p class="catalog__item-description">{{ goods.description }}</p>
          </div>
          <div class="catalog__item-footer">
            ...
            <span class="catalog__item-price">{{ goods.price }} ₽</span>
          </div>
        </li>
      </ul>
    </div>
